<!-- Template Default untuk jenis surat lainnya -->
@php
    $letterTypes = [
    ...
    $letterTitle = $letterTypes[$letter->letter_type] ?? 'SURAT KETERANGAN';
@endphp
...
<div class="letter-title" style="text-align: center; margin: 30px 0 20px 0;">
    <h3 style="text-decoration: underline; margin-bottom: 10px; font-size: 16px; color: #666;">{{ $letterTitle }}</h3>
