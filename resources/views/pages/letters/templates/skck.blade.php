...
<div class="letter-title" style="text-align: center; margin: 30px 0 20px 0;">
    <h3 style="text-decoration: underline; margin-bottom: 10px; font-size: 16px; color: #666;">SURAT PENGANTAR SKCK</h3>
...
<div class="letter-body" style="font-size: 13px; line-height: 1.8; color: #333;">
    ...
    <p style="text-indent: 40px; text-align: justify; margin: 20px 0 10px 0;">
        Adalah benar penduduk Kampung Badran Sari yang berkelakuan baik, tidak pernah terlibat dalam tindak kriminal, dan tidak sedang dalam proses hukum. Surat pengantar ini dibuat untuk:
    </p>
    ...
    <p style="text-indent: 40px; text-align: justify; margin-top: 20px;">
        Demikian surat pengantar ini dibuat untuk dapat dipergunakan sebagai salah satu persyaratan pengurusan Surat Keterangan Catatan Kepolisian (SKCK) di instansi yang berwenang.
    </p>
</div>
