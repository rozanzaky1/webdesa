            ...
            <div class="card shadow">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="mb-4 pb-4 border-bottom">
                        <h5 class="mb-3"><i class="fas fa-tasks mr-2"></i> Status Pengajuan</h5>
                        <div class="timeline">
                            <div class="timeline-item {{ $submission['status'] == 'pending' ? 'active' : 'completed' }}">
                            ...
                            <div class="timeline-item {{ $submission['status'] == 'approved' || $submission['status'] == 'rejected' ? 'completed' : '' }}">
                                <div class="timeline-marker">
                                    <i class="fas fa-check"></i>
                                </div>
                                <div class="timeline-content">
                    ...
                    @if($submission['status'] === 'approved' && !empty($submission['letter_number']))
                    <div class="mt-4">
